...
contract Ownable {
    ...
    modifier onlyOwner(){
        require(msg.sender==_owner, "Only owner is allowed to perform this Ownable op.");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != _tokenOwner[tokenId], "Address cannot be token owner.");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(isApprovedForAll(_tokenOwner[tokenId], to) || _tokenOwner[tokenId] == msg.sender, "Caller neither owner or approvedForAll.");
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "Caller needs to be to.");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "From address should be owner");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        require(_exists(tokenId), "tokenURI: TokenId doesn't exists");
    ...
    function setTokenURI(uint256 tokenId) internal {
        require(_exists(tokenId), "setTokenURI: TokenId doesn't exists");
...
contract CustomERC721Token is ERC721Metadata {
    ...
    string private constant NAME = "Anubhab's Housing Token";
    string private constant SYMBOL = "AHT";
